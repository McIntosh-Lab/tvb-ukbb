...
subject_folder_list=/Users/justinwang/Documents/McIntosh/ukbbqc/QC/scripts/subject_folder_list_AD.txt


#MAYBE SPLIT CODE INTO MULTIPLE SCRIPTS FOR READABILITY

T2_FLAIR_brain_to_MNI_path=/T2_FLAIR/T2_FLAIR_brain_to_MNI.nii.gz
...
cat $subject_folder_list | while read subject_folder; do
	...
	output_folder=$subject_folder/QC/images/T2_preprocess_registration/edges
	...
	slicer $standard_folder$MNI152_T1_1mm_path $subject_folder$T2_FLAIR_brain_to_MNI_path $arguments1
	#echo "done 1"
	slicer $subject_folder$T2_FLAIR_brain_to_MNI_path $standard_folder$MNI152_T1_1mm_path $arguments2
	#echo "done 2"
	echo "done $sub"
