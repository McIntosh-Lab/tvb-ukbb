...
### dMRI EXTRACTION ###
	...
	#dMRI extraction unmasked
		$BB_BIN_DIR/tvb_bb_QC/lightbox.sh -b 52.5199 -c 99.95406 /dMRI/dMRI/data_B0.nii.gz $dirSubject dMRI_extraction_unmasked
	...
	#dMRI extraction masked
		$BB_BIN_DIR/tvb_bb_QC/lightbox.sh -o /dMRI/dMRI/nodif_brain_mask.nii.gz -b 52.5199 -c 99.95406 /dMRI/dMRI/data_B0.nii.gz $dirSubject dMRI_extraction_masked
