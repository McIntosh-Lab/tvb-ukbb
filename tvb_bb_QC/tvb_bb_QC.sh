...
### T1 REGISTRATION ###
	...
	if [ -e "$dirSubject/T2/T2.nii.gz" ]; then	#maybe -r if readable?
		...
		$BB_BIN_DIR/tvb_bb_QC/image_gen_link.sh $dirSubject "Tre_under_1" "../../T2/T2.nii.gz" "Tre_over1_1" "../../T1/T1.nii.gz" "NA14" "NA14_link" 0
		$BB_BIN_DIR/tvb_bb_QC/image_gen_link.sh $dirSubject "Tre_under_2" "../../T1/T1.nii.gz" "Tre_over1_2" "../../T2/T2.nii.gz" "NA15" "NA15_link" 0
...
### IDP REPORT GEN ###
	...
	python $BB_BIN_DIR/tvb_bb_QC/IDP_postprocessing.py $dirSubject $BB_BIN_DIR/bb_IDP/dataset-ukbb_parc-${PARC_NAME}_IDPlist.tsv $BB_BIN_DIR/bb_IDP/IDPoi.txt $BB_BIN_DIR/bb_IDP/thresholds.tsv
